...
public class ProductController {
    ...
    public String lisProducts(
    	      ...
    	      @RequestParam("size") Optional<Integer> size) {
    	        ...
    	        Page<ProductInfo> productPage = productService.findPaginated(PageRequest.of(currentPage - 1, pageSize));
    ...
    @RequestParam("size") Optional<Integer> size) {
      ...
      int pageSize = size.orElse(12);
        ...
        Page<ProductInfo> productPage = productService.findPaginated(searchword,PageRequest.of(currentPage - 1, pageSize));
