...
public class ProductServiceImpl implements ProductService {
	...
	@Override
	public Page<ProductInfo> findPaginated(Pageable pageable) {
	...
	@Override
	public Page<ProductInfo> findPaginated(String searchword,Pageable pageable) {
		List<ProductInfo> products=search(searchword);
